...
g.add_edge("scale",3)
g.add_node("tf.reduce_mean")
g.add_edge(3,"tf.reduce_mean")
g.add_node("gradientHatD")
g.add_edge("tf.reduce_mean","gradientHatD")

g.add_node(11,label = "tf.reduce_mean")
g.add_node(12,label = "tf.reduce_mean")
g.add_edge("rD",11)
g.add_edge("fD",12)
g.add_node(13,label="-")
g.add_edge(11,13)
...
g.add_node(21,label="+")
g.add_edge(12,21)
g.add_node(22,label="tf.reduce_mean")
g.add_node("0.5")
g.add_node(23,label="*")
g.add_edge("0.5",23)
g.add_node(24,label = "tf.square")
...
g.add_node(31,label="tf.train.AdamOptimizer.minimize")
g.add_node(32,label="tf.train.AdamOptimizer.minimize")
